...
//recherche de l'utilisateur qui a pour id la valeur $_POST['id']
$sqlupdate="select * from users where id=".$_POST['id'];
$resultat=mysqli_query($conn,$sqlupdate);
...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Modifier Employé</h1>
        ...
        <div class="col-md-2 my-2">
                ...
                <input type="text" readonly class="form-control" id="validationCustom01" value="<?= $user[0];?>" required name="id">
                <div class="valid-feedback">
                </div>
            </div>
            <div class="col-md-5 my-2">
                <label for="validationCustom01" class="form-label">Nom :</label>
                <input type="text" class="form-control" id="validationCustom01" value="<?= $user[1];?>" required name="nom">
                <div class="valid-feedback">
                Looks good!
                </div>
            </div>
            <div class="col-md-5 my-2">
                ...
                <input type="email" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="email" required value="<?= $user[2];?>">
            ...
            <div class="col-md-6 my-2">
                ...
                <select name="role" class="form-control" id="validationCustom04" required value="<?= $user[3];?>">
                
                <option value="admin">Administrateur</option>
                <option value="ff" selected>Test</option>
            ...
            <div class="col-12 my-4">
                <button class="btn btn-primary" type="submit" name="btn_modifier">Modifier</button>
            </div>
</form>
        </div>
